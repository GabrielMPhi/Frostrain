class StationFactory{
    ...
    get_station({id, nom, population, infrastructure, corruption, influence_du_joueur, reserve_de_charbon, destinations_possible}){
        let liste_population_station = this.creer_liste_personnage_stations(population)
        return new Station(id, nom, population, infrastructure, corruption, influence_du_joueur, liste_population_station, reserve_de_charbon, destinations_possible)
    }
