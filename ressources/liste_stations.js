...
let vilnius_station = station_factory.get_station({id:"vilnius_station", nom: "Station Vilnius", population : 5, infrastructure : 100, corruption : 15, influence_du_joueur : 10, ressources : 10, reserve_de_charbon : 100, destinations_possible : ["moscow_station", "london_station"]}) 
let moscow_station = station_factory.get_station({id:"moscow_station", nom: "Station Moscou", population : 5, infrastructure : 100, corruption : 15, influence_du_joueur : 10, ressources : 10, reserve_de_charbon : 100, destinations_possible : ["montreal_station"]}) 


let liste_des_stations = [montreal_station,london_station,vilnius_station, moscow_station]
